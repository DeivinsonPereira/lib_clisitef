...
import 'package:impl_projeto_clisitef/services/clisitef/model/data_events.dart';
import 'package:impl_projeto_clisitef/services/clisitef/model/pinpad_events.dart';
import 'package:impl_projeto_clisitef/services/clisitef/native_channel/channel.dart';
import 'package:intl/intl.dart';

import '../services/clisitef/clisitef_sdk.dart';
import '../services/clisitef/model/clisitef_data.dart';
import '../services/clisitef/model/pinpad_information.dart';
import '../services/clisitef/model/tipo_pinpad.dart';
import '../services/clisitef/model/transaction_events.dart';
...
class CliSiTefAndroid implements CliSiTefSDK {
  ...
  static final Channel channel = Channel();
  ...
  void setDataHandler(Data2Void listener) {
    channel.dataChannel.receiveBroadcastStream().listen((dataEvent) => listener(
        CliSiTefData(
  ...
  Future<bool> abortTransaction({int continua = 0}) async {
    bool? success = await channel.methodChannel
  ...
  Future<bool> configure(
    ...
    bool? success =
        await channel.methodChannel.invokeMethod<bool>('configure', {
  ...
  Future<bool> finishTransaction(
    ...
    bool? success =
        await channel.methodChannel.invokeMethod<bool>('finishTransaction', {
  ...
  Future<bool> finishLastTransaction(bool confirma) async {
    bool? success = await channel.methodChannel
        .invokeMethod<bool>('finishLastTransaction', {
      'confirma': confirma == true ? 1 : 0,
    });
  ...
  Future<bool> continueTransaction(String data) async {
    bool? success =
        await channel.methodChannel.invokeMethod<bool>('continueTransaction', {
      'data': data,
    });
  ...
  Future<int> getPinPadYesOrNo(String message) async {
    int? result = await channel.methodChannel
  ...
  Future<PinPadInformation> getPinpadInformation() async {
    bool? isPresent =
        await channel.methodChannel.invokeMethod<bool>('pinpadIsPresent');
  ...
  Future<int?> getTotalPendingTransactions(
    ...
    return await channel.methodChannel
  ...
  Future<bool> startTransaction(
    ...
    bool? success =
        await channel.methodChannel.invokeMethod<bool>('startTransaction', {
